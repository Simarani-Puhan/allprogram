...
public class InsuranceController {
	...
	ResponseEntity<List<Insurance>>  getBrandAndType(@PathVariable("brand") String brand, @PathVariable("type") String type) {

		List<Insurance>insurances= insuranceService.getBrandAndType(brand, type);
