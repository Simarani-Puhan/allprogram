...
public interface IInsuranceService {
	...
	List<Insurance>getBrandAndType(String brand,String type)throws InsuranceNotFoundException;
	List<Insurance>getByTypeAndLesserPremium(String brand,double premium)throws InsuranceNotFoundException;
